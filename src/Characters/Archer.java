...
public class Archer extends Character {
    ...
    //Constructor.
    public Archer(String name, int health, int strength, int agility, int intellect, int defense, int speed) {

        //La fuerza y el intelecto los ponemos en 0 porque el arquero no los utiliza.
