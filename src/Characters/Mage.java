...
public class Mage extends Character {
    ...
    //Constructor.
    public Mage(String name, int health, int strength, int agility, int intellect, int defense, int speed) {

        //La fuerza y la agilidad las ponemos en 0 porque no la utiliza, el daño del mago depende de su intelecto.
        super(name, health, 0, 0, intellect, defense, speed);
    ...
    public int Attack(Character enemy) {
        ...
        int damage = this.getIntellect() - enemy.getDefense() / 2; //Entre dos, si no sería muy poco daño.
