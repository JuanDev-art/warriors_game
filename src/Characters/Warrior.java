...
public class Warrior extends Character {
    ...
    //Constructor.
    public Warrior(String name, int health, int strength, int agility, int intellect, int defense, int speed) {

        //La agilidad y el intelecto las ponemos en 0 porque no la utiliza, el daño del mago depende de su intelecto.
        super(name, health, strength, 0, 0, defense, speed);
        ...
        public int Attack (Character enemy){
            ...
            int damage = this.getStrength() - enemy.getDefense() / 2; //Entre dos, si no sería muy poco daño.
